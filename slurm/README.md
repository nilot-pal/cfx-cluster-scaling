...
For the memory-heavy particle-tracking runs, the relevant lever is *fewer* ranks per node — more
memory headroom per rank — which is the opposite of what you want for throughput. See
